...
/*   Updated: 2020/08/25 16:43:36 by gbouwen       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout	<< "FRAGTRAP [" << this->_name << "]: Ranged attack on " << target
...
{
	std::cout	<< "FRAGTRAP [" << this->_name << "]: Melee attack on " << target
...
void	FragTrap::takeDamage(unsigned int amount)
{
	...
	{
		std::cout << "FRAGTRAP [" << this->_name << "]: That did nothing to me! No damage taken" << std::endl;
		return ;
	}
	...
	if (actualDamage <= this->_hitPoints)
		...
		this->_hitPoints = 0;
	std::cout	<< "FRAGTRAP [" << this->_name << "]: Took " << actualDamage
...
void	FragTrap::beRepaired(unsigned int amount)
{
	if ((this->_hitPoints + amount) > this->_maxHitPoints)
	{
		...
		std::cout	<< "FRAGTRAP [" << this->_name << "]: Back to full health! Current hitpoints: "
					<< this->_hitPoints << std::endl;
	}
	else
	{
		this->_hitPoints += amount;
		std::cout	<< "FRAGTRAP [" << this->_name << "]: Restored " << amount
